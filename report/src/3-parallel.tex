...
To address this efficiently, we implemented a thread-local arena: at the beginning of the merge phase, each thread creates a temporary private arena; the allocation of memory to create a new node doesn't touch the global arena, but only the private arena and this means no synchronization.
